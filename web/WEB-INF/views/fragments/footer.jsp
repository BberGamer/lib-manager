<%--
    Fragment hiển thị chân trang dùng chung cho các trang do controller chuyển tiếp đến JSP.
    Mong đợi request attribute `isManagePageAttr` để chọn giao diện quản trị và session
    attribute `loggedUser` để hiển thị liên kết đăng nhập hoặc đăng xuất.
--%>
                    ...
                    <div>
                        ...
                        <ul class="footer-links">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a href="${logoutUrl}"><i class="fa-solid fa-right-from-bracket fa-xs"></i> Đăng xuất</a></li>
                                </c:otherwise>
                            </c:choose>
                        </ul>
                    </div>
