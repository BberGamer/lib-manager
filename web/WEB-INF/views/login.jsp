<%-- Mục đích: Trang đăng nhập hệ thống thư viện. Tầng: Presentation Layer (JSP View - WEB-INF/views/login.jsp) Phụ
    trách bởi: LoginServlet (/login) Thuộc tính nhận: request.error, request.success --%>
