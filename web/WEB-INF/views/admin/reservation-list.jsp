        ...
        <div style="background: white; border-radius: 12px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); margin-bottom: 30px;">
            <form action="${pageContext.request.contextPath}/admin/reservation/list" method="get" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: flex-end;">
                ...
                <div>
                    ...
                    <a href="${pageContext.request.contextPath}/admin/reservation/list" class="btn btn-secondary" style="padding: 10px 20px; border-radius: 8px; text-decoration: none; margin-left: 8px; display: inline-block;">
                        Đặt lại
                    </a>
                </div>
            </form>
        ...
        <c:if test="${totalPages > 1}">
            <div style="display: flex; justify-content: center; gap: 10px; margin-top: 30px;">
                <c:forEach begin="1" end="${totalPages}" var="i">
                    <a href="${pageContext.request.contextPath}/admin/reservation/list?status=${selectedStatus}&keyword=${keyword}&page=${i}" 
