                    ...
                    <% int rowNum = (currentPageNum - 1) * 12 + 1;
                       for (Book b : books) { %>
                        <tr>
                            ...
                            <td>
                                <span class="badge <%= b.getAvailable() > 0 ? "badge-success" : (b.isReservable() ? "badge-warning" : "badge-danger") %>">
                            ...
                            <td style="text-align:center;">
                                <div style="display:flex; gap:6px; justify-content:center;">
                                    ...
                                    <form method="post" action="<%= ctx %>/borrow/create" class="book-borrow-form">
                                        ...
                                        <button type="submit" class="btn btn-sm" title="Gửi yêu cầu mượn sách">
                                            <i class="fa-solid fa-book-open"></i> Mượn sách
                                        </button>
                                    </form>
                                    <% } %>
                                    <% if (b.getAvailable() > 0 || b.isReservable()) { %>
                                    <a class="btn btn-sm" href="<%= ctx %>/reservation/create?bookId=<%= b.getId() %>">
                                        <i class="fa-solid fa-bookmark"></i> Đặt trước
                                    </a>
                                    <% } else { %>
                                    <button type="button" class="btn btn-sm" disabled
                                            title="Không còn lượt mượn đúng hạn để dự kiến ngày trả">
                                        <i class="fa-solid fa-ban"></i> Chưa thể đặt
                                    </button>
                                    <% } %>
                                    <% } %>
                                </div>
                ...
                <div class="book-card">
                    ...
                    <div class="book-footer">
                        ...
                        <div style="display:flex; gap:6px;">
                            ...
                            <% if (b.getAvailable() > 0) { %>
                                <form method="post" action="<%= ctx %>/borrow/create"
                            ...
                            <% if (b.getAvailable() > 0 || b.isReservable()) { %>
                                <a class="btn btn-sm"
                                   href="<%= ctx %>/reservation/create?bookId=<%= b.getId() %>">
                                    <i class="fa-solid fa-bookmark"></i> Đặt trước
                                </a>
                            <% } else { %>
                                <button type="button" class="btn btn-sm" disabled
