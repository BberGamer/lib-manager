<%-- Tên file: login.jsp Mục đích: Trang hiển thị giao diện đăng nhập cho người dùng và thủ thư/quản trị viên. Tầng:
    Giao diện (Presentation Layer - JSP View) Trách nhiệm: Hiển thị form đăng nhập, xử lý hiển thị thông báo lỗi/thành
    công từ controller, liên kết stylesheet toàn cục style.css và stylesheet riêng login.css. --%>
                                    ...
                                    <form method="POST" action="${pageContext.request.contextPath}/login"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="username" name="username" value="${param.username}"
                                                required placeholder="Nhập tên đăng nhập" class="form-control">
                                        </div>
                                    ...
                                    <div class="info-box">
                                        <div class="info-icon info-logo-wrap">
                                            <img src="${pageContext.request.contextPath}/assets/images/logo.png"
                                                alt="FPT University" class="info-logo-img">
                                        </div>
