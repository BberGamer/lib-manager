...
public class ShelfValidationException extends Exception {
    ...
    public ShelfValidationException(Map<String, String> validationErrors) {
        super("Dữ liệu kệ sách không hợp lệ"); this.validationErrors = validationErrors;
    }
    /** @return bản đồ lỗi validation */ public Map<String, String> getValidationErrors() { return validationErrors; }
}
